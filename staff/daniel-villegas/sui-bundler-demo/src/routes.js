...
const loadContactPage = async (nextState, cb) => {
  const component = await import(/* webpackChunkName: "Contact" */ './pages/Contact')
  cb(null, component.default)
}

const loadSearchResultPage = async (nextState, cb) => {
  const component = await import(/* webpackChunkName: "Contact" */ './pages/Contact')
  cb(null, component.default)
}
  ...
  <Router>
    <Route component={App}>
      <Route path='/'>
        ...
        <Route path="search/:query" getComponent={loadSearchResultPage} />
      </Route>
    </Route>
  </Router>
)
