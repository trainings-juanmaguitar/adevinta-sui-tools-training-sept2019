...
var _factory = require('../Mappers/factory');

var _factory2 = _interopRequireDefault(_factory);

var _factory3 = require('../../logger/factory');
...
var MoviesRepositoryFactory = (_temp = _class = function MoviesRepositoryFactory() {
  ...
  return new _HTTPMoviesRepository2.default({
    config: config,
    mapper: _factory2.default.moviesMapper({ config: config }),
    log: (0, _factory4.default)({ prefix: 'HTTPMoviesRepository' }),
